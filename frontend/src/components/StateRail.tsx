const PIPELINE: { state: string; label: string }[] = [
          ...
          return (
            <div key={step.state} className="flex items-center">
              <div className="flex flex-col items-center gap-2 w-[92px]">
                <div
                  className={`w-3.5 h-3.5 rounded-full border-2 transition-all duration-300 ${isCurrent ? "animate-pulse-dot" : ""}`}
                  style={{
        ...
        {failed && (
          <div className="flex items-center">
            ...
            <div className="flex flex-col items-center gap-2 w-[92px]">
              ...
              />
              <span className="text-[10px] font-mono text-center leading-tight" style={{ color: "var(--color-text)" }}>
