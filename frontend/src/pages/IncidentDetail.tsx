...
import { api, type IncidentDetail as IncidentDetailType } from "../lib/api";
      ...
      >
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-xs font-mono mt-1" style={{ color: "var(--color-dim)" }}>
        ...
        {ctx.description && (
          <div className="mb-4">
            <label className="text-[10px] font-mono uppercase tracking-wider mb-1 block" style={{ color: "var(--color-dim)" }}>Description</label>
            <p className="text-xs leading-relaxed" style={{ color: "var(--color-muted)" }}>{ctx.description}</p>
          </div>
        )}
