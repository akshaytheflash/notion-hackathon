...
import { api, type Policy, type WorkflowEvent } from "../lib/api";
    ...
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-md px-4 py-2 text-xs font-semibold transition-all duration-200 hover:opacity-90"
          style={{
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="rounded px-3 py-2 text-xs w-full"
                style={{
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-md px-4 py-2 text-xs font-semibold transition-all duration-200 hover:opacity-90 disabled:opacity-50"
              style={{
                ...
                >
                  ...
                  {typeof payload.violation === "string" &&
                    payload.violation && (
                      <div className="mt-3">
                        <label
                          className="text-[10px] font-mono uppercase tracking-wider mb-0.5 block"
                          style={{ color: "var(--color-dim)" }}
                        >
                          Violation
                        </label>
