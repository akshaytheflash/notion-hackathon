 ...
 * workflow's events to every connected socket regardless of {id} (see
 * CURRENT_PROGRESS.md — known limitation, not filtered server-side yet).
 * So a single connection here is enough to drive a live command-center feed.
 */
